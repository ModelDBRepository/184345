'''
Current clamp demo using Allen Brain's model 473872986.
...
from neuron473872986 import Neuron473872986
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473872986(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473872986; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-96.2065906525)
        h.fcurrent()
